<div class="remodal" data-remodal-id="edit-modal-{{$resume->resume_id}}" data-remodal-options="hashTracking: false">
					  <button data-remodal-action="close" class="remodal-close"></button>
						...
						<form  id="edit-resume-form{{$resume->resume_id}}" method="POST" enctype="multipart/form-data">
							...
							<a href="javascript:previewResume('edit-resume-form{{$resume->resume_id}}');" class="button big margin-top-5" target="_blank">Update Resume<i class="fa fa-arrow-circle-right"></i></a>
										</div>
</div>
