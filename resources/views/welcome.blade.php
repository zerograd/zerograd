    ...
    <body>
        ...
        <div id="Container">
            ...
            <div class="search-boxes col-md-6 col-xs-6 col-md-offset-3">
                <input class="col-md-8 col-xs-8 col-md-offset-2" type="text" name="search-keywords" id="search-keywords" placeholder="Keywords" />
                <input class="col-md-8 col-xs-8 col-md-offset-2" type="text" name="search-location" id="search-location" placeholder="Location"/>
            </div>
            <div class="search-button-div col-md-12 col-xs-12">
                    <button class="white-btn" style="background-color:#354886;margin:10px auto;padding:5px 15px">Search</button>
