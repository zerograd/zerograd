...
@stop
        ...
        <script type="text/javascript">
            ...
            function filter(){
                ...
                var to  = $('#to').val();
                var category = $('#category').val();
                $.post('{{route('api-filter')}}',{category:category,keywords:$('#searchkeywords').val(),jobtypes:jobsList,levels:levelsList,location:location,date:date,from:from,to:to,_token:"{{csrf_token()}}"},function(data){
