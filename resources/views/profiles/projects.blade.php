...
@foreach($educations as $education)
	<div class="form-group" style="margin:10px 0;" class="entered-school">
		<div class="col-sm-4"><label class="label-color">Project Name</label><input type="text" class="form-control" style="font-weight: bold;" value="{{$education->school}}"readonly></div>
		<div class="col-sm-3"><label class="label-color">Project Skills</label><input type="text" class="form-control" style="font-weight: bold;" value="{{$education->program}}" readonly></div>
