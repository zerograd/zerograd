...
{{csrf_token()}}
	<div class="form-group" style="margin:10px 0;" class="entered-school">
		...
		<div class="col-sm-2"><label class="label-color">Start</label>
			<select class="form-control label-color" style="font-weight:bold;" name="project_start" disabled>
		...
		<select class="form-control label-color" style="font-weight:bold;" name="project_completed" disabled>
				<option style="font-weight:bold;" value="2013">2013</option>
