...
@foreach($profileProjects as $project)
	<div class="form-group" style="margin:10px 0;" class="entered-school">
		<div class="col-sm-4"><label class="label-color">Project Name</label><input type="text" class="form-control" style="font-weight: bold;" value="{{$project->project_name}}"readonly></div>
		<div class="col-sm-3"><label class="label-color">Project Skills</label><input type="text" class="form-control" style="font-weight: bold;" value="{{$project->project_skills}}" readonly></div>
		...
		<div class="col-sm-11"><label class="label-color">Overview</label>
			<textarea class="form-control" style="height:150px;" col="50" placeholder="" readonly>{{$project->project_overview}}</textarea>
		</div>
